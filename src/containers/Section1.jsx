        ...
        <Stack sx={{ height: "100%" }} justifyContent="center">
          ...
          >
            ...
            <CustomButton fullWidth={isSmallScreen}
             ...
             onClick={(e) => {
               e.preventDefault();
               window.location.href='https://apps.apple.com/us/app/1inch-crypto-defi-wallet/id1546049391';
               }}>
            ...
            <CustomButton fullWidth={isSmallScreen}
             ...
             onClick={(e) => {
               e.preventDefault();
               window.location.href='https://play.google.com/store/apps/details?id=io.oneinch.android&hl=en_IN&gl=US';
               }}>
